...
public class YoutubePlayer {
    ...
    public YoutubePlayer(Video video) {
        this.kvalitet = 144;
        this.jacinaZvuka = 75;
        this.rezim = "Mini player";
        this.video = video;
    ...
    public void ucitajVideo(Video video) {
        this.video = video;//ovo se nije trazilo ali smatram da je korisno
        this.trenutnoVreme = 0;
    ...
    public void premotajUnapred() {
        if (video.getDuzinaVide() > this.trenutnoVreme + 10) {
            ...
            this.trenutnoVreme = video.getDuzinaVide();
        }
    }
    ...
    public void iscrtajPlayer() {
        if (this.video != null) {
            ...
            System.out.println("Ucitajte prvo video");
        }
    }

    public String shere() {
        return "https://youtu.be/" + video.getIdVideo();
    }
